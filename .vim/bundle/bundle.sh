...
git clone 'https://github.com/google/vim-ft-go.git' "$HOME"/.vim/bundle/'go'
git clone 'https://github.com/vim-jp/vim-go-extra.git' "$HOME"/.vim/bundle/'go-extra'
...
git clone 'https://github.com/tommcdo/vim-lion.git' "$HOME"/.vim/bundle/'lion'
